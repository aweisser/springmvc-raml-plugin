...
public interface RamlStyleChecker {
	 ...
	 * @return A list of style issues or an Empty List if none are found. This method must not return null.
	 */
	public Set<StyleIssue> checkActionStyle(RamlActionType key, RamlAction value, IssueLocation location, Raml raml);
	 ...
	 * @return A list of style issues or an Empty List if none are found. This method must not return null.
	 */
	public Set<StyleIssue> checkResourceStyle(String name, RamlResource resource, IssueLocation location, Raml raml);
